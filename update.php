...
<html lang="en">
  ...
  <body class="container bg-light">
    ...
    <form class="form-group" action="db.php" method="post">
        ...
        <br>
        <input type="text" name="h1" placeholder="Main title here" class="form-control" value="<?php echo $row['h1']; ?>">
        <br>
        <label>Update Secondary Heading:</label>
        <br>
        <input type="text" name="h2" placeholder="Secondary title here" class="form-control" value="<?php echo $row['h2']; ?>">
        <br>
